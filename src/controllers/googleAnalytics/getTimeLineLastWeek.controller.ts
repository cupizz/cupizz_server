...
class GetTimeLineLastWeekController extends BaseController<any> {
    protected async execute(req: e.Request, res: e.Response): Promise<HttpResponse<analyticsdata_v1alpha.Schema$RunReportResponse>> {
        try {
            const data = await GoogleAnalyticsService.getTimeLineLastWeek();
...
const _ = new GetTimeLineLastWeekController();
export {_ as GetTimeLineLastWeekController}