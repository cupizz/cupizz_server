# Migration `20201114085528-init`

This migration has been generated by Hien at 11/14/2020, 8:55:28 AM.
...
"minAgePrefer" integer   NOT NULL DEFAULT 18,
"maxAgePrefer" integer   NOT NULL DEFAULT 30,
"minHeightPrefer" integer   NOT NULL DEFAULT 150,
"maxHeightPrefer" integer   NOT NULL DEFAULT 180,
"genderPrefer" "Gender"[]  ,
"distancePrefer" integer   NOT NULL DEFAULT 100,
...
"isCurrentlyInChat" boolean   NOT NULL DEFAULT false,
...
CREATE TABLE "public"."NotificationReceiver" (
...
ALTER TABLE "public"."User" ADD FOREIGN KEY ("coverId")REFERENCES "public"."File"("id") ON DELETE SET NULL ON UPDATE CASCADE
...
ALTER TABLE "public"."Notification" ADD FOREIGN KEY ("refUserId")REFERENCES "public"."User"("id") ON DELETE SET NULL ON UPDATE CASCADE

ALTER TABLE "public"."NotificationReceiver" ADD FOREIGN KEY ("notificationId")REFERENCES "public"."Notification"("id") ON DELETE CASCADE ON UPDATE CASCADE

ALTER TABLE "public"."NotificationReceiver" ADD FOREIGN KEY ("receiverId")REFERENCES "public"."User"("id") ON DELETE CASCADE ON UPDATE CASCADE
