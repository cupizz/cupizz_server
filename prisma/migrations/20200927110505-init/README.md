# Migration `20200927110505-init`

This migration has been generated at 9/27/2020, 11:05:05 AM.
You can check out the [state of the schema](./schema.prisma) after the migration.

## Database Steps

```sql
CREATE TYPE "public"."PrivateField" AS ENUM ('birthday', 'introduction', 'gender', 'hobbies', 'phoneNumber', 'job', 'height')

CREATE TYPE "public"."MustHaveField" AS ENUM ('age', 'height', 'distance', 'gender')

ALTER TYPE "SocialProviderType" ADD VALUE 'instagram'

DROP TYPE "ProfileField"
...
ALTER TABLE "public"."UserAnswer" ADD FOREIGN KEY ("userId")REFERENCES "public"."User"("id") ON DELETE CASCADE ON UPDATE CASCADE
...
ALTER TABLE "public"."UserAnswer" ADD FOREIGN KEY ("backgroundFileId")REFERENCES "public"."File"("id") ON DELETE CASCADE ON UPDATE CASCADE
